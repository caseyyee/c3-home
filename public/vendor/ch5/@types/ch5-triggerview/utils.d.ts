...
export declare function clampAbs(x: number, min: number, max: number): number;
export declare function roundedTan(deg: number): number;
...
export declare function setCSSCustomProperty(element: HTMLElement, propertyName: string, propertyValue: string): void;
